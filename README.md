...
Now, we can't actually test our skill yet because we have'nt finished it yet, but we need to get our user id for finishing up our skill, so if you don't know it already, this is the fastest way I know how to get it.</br>
...
Open a Command Prompt window and navigate to location you've extracted the downloaded zip file, make sure you are in the same folder of the *pom.xml* file which is the maven instructions file on how to create the package.</br>
